...
if(isset($_POST['submit']))
{
    ...
    $activeHours = isset($_POST['activehours']) ? $_POST['activehours'] : '';
    ...
    if(empty($errors))
    {
        if(registerSupportStaff(array_merge($_POST, $_FILES))) {
            addAlert([
                't' => 'success',
                'm' => $fname . ' ' . $lname . ' Added Successfully',
                'a' => 6000
            ], 'supportstaff');
            header('location: supportstaff.php');
            exit;
        }
    }
...
<div class="block">
    ...
    <div class="body">
        <form action="addsupportstaff.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid">
                <div class="row">
                    <div class="column-6">
                        <div class="inputset<?php __errors($errors, 'hourlyrate', true) ?>">
                            <label for="hourlyrate">Hourly Salary</label>
                            <input type="text" name="hourlyrate" id="hourlyrate" value="<?php echo isset($_POST['hourlyrate']) ? htmlspecialchars($_POST['hourlyrate']) : 0 ?>" size="24"><br/>
                            <?php __errors($errors, 'hourlyrate') ?>
                        </div>
                    </div>
                    <div class="column-6">
                        <div class="inputset<?php __errors($errors, 'activehours', true) ?>">
                            <label for="activehours">Total Active</label>
                            <input type="text" name="activehours" id="activehours" value="<?php echo isset($_POST['activehours']) ? htmlspecialchars($_POST['activehours']) : 0 ?>" size="24"><br/>
            ...
            <input type="submit" class="btn submit" name="submit" value="Add Staff">
        </form>
    </div>
</div>
