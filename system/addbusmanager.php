...
if(isset($_POST['submit']))
{
    ...
    if(empty($errors))
    {
        if(registerCompany(array_merge($_POST, $_FILES), true)) {
            addAlert([
                't' => 'success',
                'm' => $companyName .' Added Successfully',
                'a' => 6000
            ], 'busmanager');
...
<div class="block">
    ...
    <div class="body">
        <form action="addbusmanager.php" method="post" enctype="multipart/form-data">
            ...
            <input type="submit" class="btn submit" name="submit" value="Add Manager">
        </form>
    </div>
</div>
