                ...
                <div class="row">
					<div class="column-6">
					    <div class="inputset<?php __errors($errors,'reg_no',true) ?>">
                            ...
                            <input type="text" name="seats_col" id="seats_col" placeholder="Column" value="<?php echo isset($_POST['seats_col']) ? htmlspecialchars($_POST['seats_col']) : '' ?>" style="width:35%"> x
                            <input type="text" name="seats_row" id="seats_row" placeholder="Row" value="<?php echo isset($_POST['reg_no']) ? htmlspecialchars($_POST['reg_no']) : '' ?>" style="width:35%">
